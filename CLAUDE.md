...
ResumeCraft is a Chinese-language online resume editor with a decoupled frontend (React 18 + Vite) and backend (Spring Boot 3.3 + MySQL + Redis). It supports modular resume editing with live preview, Markdown/TXT import, AI module optimization and whole-resume analysis, and PDF export.
...
Standard Spring Boot layout under `com.zylo.resumecraft`:

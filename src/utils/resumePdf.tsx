...
function resolveFontSource(fileName: string) {
  if (typeof window === 'undefined') {
    const fontPath = decodeURIComponent(new URL(`../../public/fonts/${fileName}`, import.meta.url).pathname)
    return /^\/[A-Za-z]:/.test(fontPath) ? fontPath.slice(1) : fontPath
  }
...
Font.register({
  ...
  fonts: [
    { src: resolveFontSource('resume-pdf-regular.ttf'), fontWeight: 400 },
    { src: resolveFontSource('resume-pdf-bold.ttf'), fontWeight: 700 },
  ],
})

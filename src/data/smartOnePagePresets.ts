...
3. 优先压缩项目经历、工作经历、实习经历、科研经历、专业技能中的冗长表达。
...
4. 重点优化工作经历、实习经历、项目经历、科研经历、专业技能。
5. 输出必须保持与输入完全相同的 JSON 结构。`,
    moduleRules: [
      '基本信息只做轻微措辞优化，不改动联系方式和核心事实。',
      '教育背景尽量保留原文，只压缩冗余说明。',
      '工作经历、实习经历、项目经历优先用更紧凑的 STAR 表达。',
...
3. 对工作、实习和项目内容，优先突出系统能力、接口设计、性能优化、稳定性、工程实践。
4. 弱化无关铺垫，保留关键技术名词、动作和结果。
5. 输出必须严格保持原 JSON 结构。`,
    moduleRules: [
      '工作经历、实习经历、项目经历优先突出服务、接口、数据流、性能、稳定性、工程效率。',
